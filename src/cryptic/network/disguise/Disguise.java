package cryptic.network.disguise;

import org.bukkit.Bukkit;
import org.bukkit.entity.Player;
import org.bukkit.inventory.ItemStack;

import cryptic.network.reflections.ReflectionUtils;
import cryptic.network.reflections.ReflectionUtils.PackageType;
...
public class Disguise
{
	...
	{
		if (to.equals(disguised)) throw new IllegalArgumentException(
		...
		if (hand != null) sendArmorContentPackets(to, disguised.getEntityId(),
				0, hand);
		if (helm != null) sendArmorContentPackets(to, disguised.getEntityId(),
				1, helm);
		if (chst != null) sendArmorContentPackets(to, disguised.getEntityId(),
				2, chst);
		if (leg != null) sendArmorContentPackets(to, disguised.getEntityId(),
				3, leg);
		if (boot != null) sendArmorContentPackets(to, disguised.getEntityId(),
				4, boot);
	...
	// Dont mind this
	private void sendPacket(Player p, Object pack)
