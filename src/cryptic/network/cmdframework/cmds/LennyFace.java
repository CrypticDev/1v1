...
public class LennyFace implements CommandListener {
	...
	@Command(name = "lenny", description = "( ͡° ͜ʖ ͡°)", usage = "( ͡° ͜ʖ ͡°)", aliases = {"( ͡° ͜ʖ ͡°)", "lennyface", "hue", "creepy", })
	public void lenny(final CommandArgs info)
	{
		info.getSender().sendMessage("( ͡° ͜ʖ ͡°)");
		CrypticMain.get()
			.getServer().getScheduler().scheduleSyncDelayedTask(CrypticMain.get(), new Runnable() {
			  public void run() {
				  info.getSender().sendMessage("( ͡° ͜ʖ ͡°)");
			  }
		}, 120L);
